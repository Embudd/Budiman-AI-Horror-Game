...
public class PlayerCharacterFlashlight : MonoBehaviour
{
    ...
    public bool hasFlashlight
    {
        get
        {
            bool result = _owner.Inventory.CheckItem(ItemID.Flashlight);
            HUDManager.Instance.BatteryUI.SetVisible(result);
            return result;
        }
    }
